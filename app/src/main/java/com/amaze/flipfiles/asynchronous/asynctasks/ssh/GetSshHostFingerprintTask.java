 ...
 *
 * Mainly used by {@link com.amaze.flipfiles.ui.dialogs.SftpConnectDialog} on saving SSH
 * connection settings.
 *
 * @see HostKeyVerifier
 * @see SSHClient#addHostKeyVerifier(String)
 * @see com.amaze.flipfiles.ui.dialogs.SftpConnectDialog#onCreateDialog(Bundle)
 */
