...
package com.amaze.flipfiles.asynchronous.asynctasks;
...
import com.amaze.flipfiles.utils.OnAsyncTaskFinished;
...
public class LoadFilesListTask extends AsyncTask<Void, Void, Pair<OpenMode, ArrayList<LayoutElementParcelable>>> {
     ...
     *
     * @param path the path to the directory tree, starts with prefix {@link com.amaze.flipfiles.utils.OTGUtil#PREFIX_OTG}
