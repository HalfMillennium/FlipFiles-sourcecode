...
package com.amaze.flipfiles.asynchronous.asynctasks.ssh;
...
import com.amaze.flipfiles.asynchronous.asynctasks.AsyncTaskResult;
...
import static com.amaze.flipfiles.filesystem.ssh.SshConnectionPool.SSH_CONNECT_TIMEOUT;

/**
 * {@link AsyncTask} for authenticating with SSH server to verify if parameters are correct.
 *
 * Used by {@link com.amaze.flipfiles.ui.dialogs.SftpConnectDialog}.
 *
 * @see SSHClient
 * @see SSHClient#authPassword(String, String)
 * @see SSHClient#authPublickey(String, KeyProvider...)
 * @see com.amaze.flipfiles.ui.dialogs.SftpConnectDialog#authenticateAndSaveSetup(String, String, int, String, String, String, String, KeyPair, boolean)
 * @see com.amaze.flipfiles.filesystem.ssh.SshConnectionPool#create(Uri)
 */
