...
import com.amaze.flipfiles.utils.EditTextColorStateUtil;
import com.amaze.flipfiles.utils.SimpleTextWatcher;
import com.amaze.flipfiles.utils.SmbUtil;
...
public class SmbConnectDialog extends DialogFragment {
    ...
    public interface SmbConnectionListener {
         ...
         *             See {@link com.amaze.flipfiles.database.UtilsHandler#removeSmbPath(String, String)}
         */
