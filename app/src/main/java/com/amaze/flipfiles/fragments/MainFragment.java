...
package com.amaze.flipfiles.fragments;
...
import com.amaze.flipfiles.activities.MainActivity;
import com.amaze.flipfiles.activities.superclasses.ThemedActivity;
import com.amaze.flipfiles.adapters.RecyclerAdapter;
import com.amaze.flipfiles.adapters.data.LayoutElementParcelable;
import com.amaze.flipfiles.asynchronous.asynctasks.DeleteTask;
import com.amaze.flipfiles.asynchronous.asynctasks.LoadFilesListTask;
import com.amaze.flipfiles.asynchronous.handlers.FileHandler;
import com.amaze.flipfiles.database.CloudHandler;
import com.amaze.flipfiles.database.CryptHandler;
import com.amaze.flipfiles.database.SortHandler;
import com.amaze.flipfiles.database.models.EncryptedEntry;
import com.amaze.flipfiles.database.models.Tab;
import com.amaze.flipfiles.filesystem.CustomFileObserver;
...
import com.amaze.flipfiles.filesystem.MediaStoreHack;
import com.amaze.flipfiles.filesystem.PasteHelper;
import com.amaze.flipfiles.filesystem.ssh.SshClientUtils;
import com.amaze.flipfiles.ui.dialogs.GeneralDialogCreation;
import com.amaze.flipfiles.ui.icons.MimeTypes;
import com.amaze.flipfiles.ui.views.DividerItemDecoration;
import com.amaze.flipfiles.ui.views.FastScroller;
import com.amaze.flipfiles.ui.views.RoundedImageView;
import com.amaze.flipfiles.ui.views.WarnableTextInputValidator;
import com.amaze.flipfiles.utils.BottomBarButtonPath;
...
import com.amaze.flipfiles.utils.SmbStreamer.Streamer;
import com.amaze.flipfiles.utils.Utils;
import com.amaze.flipfiles.utils.cloud.CloudUtil;
import com.amaze.flipfiles.utils.files.CryptUtil;
import com.amaze.flipfiles.utils.files.EncryptDecryptUtils;
import com.amaze.flipfiles.utils.files.FileListSorter;
...
import static com.amaze.flipfiles.fragments.preference_fragments.PreferencesConstants.*;
import static com.amaze.flipfiles.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_DIVIDERS;
import static com.amaze.flipfiles.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_GOBACK_BUTTON;
...
public class MainFragment extends android.support.v4.app.Fragment implements BottomBarButtonPath {
    ...
    private final String TAG = "InterstitialAd_MainFrag";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        interstitialAd = new InterstitialAd(getActivity(), "1873021463006375_1873022379672950");
        ...
        adView = new AdView(getActivity(), "1873021463006375_1873021709673017", AdSize.BANNER_HEIGHT_50);
